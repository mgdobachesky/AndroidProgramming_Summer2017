...
public class bottomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lblResults = view.findViewById(R.id.lblResults);
    ...
    public void displayBankAccounts() {
        List<BankAccount> bankAccounts = db.getAllBankAccounts();
        StringBuffer bankAccountBuffer = new StringBuffer();
        for(int i = 0; i < bankAccounts.size(); i++) {
            bankAccountBuffer.append(bankAccounts.get(i).toString());
            bankAccountBuffer.append("\n");
        }
        lblResults.setText(bankAccountBuffer.toString());
    }
